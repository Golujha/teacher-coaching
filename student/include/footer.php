            ...
            <div class="row row-cols-lg-2 row-cols-md-2 rows-cols-sm-2 row-cols-1">
                <div class="col mb-4">
                    <div class="ad-pro d-flex">
                        <span class=" ms-2 text-light"><h5>Golu jha</h5><p class="small h6 text-muted">Tutor</p></span>
                    </div>
                    <div class="phone d-flex mt-4">
                        <span class=" text-muted pt-1"><i class="fa fa-phone"></i></span>
                        <span class=" ms-2 text-light text-muted">+91 6207002686</span>
                    </div>
                    <div class="email d-flex mt-3">
                        <span class=" text-muted pt-1"><i class="fa fa-envelope"></i></span>
                        <span class=" ms-2 text-light text-muted">golu@gmail.com</span>
                    </div>
                    <div class="email d-flex mt-3">
                        <span class=" text-muted pt-1"><i class="fa fa-map-marker"></i></span>
                        <span class=" ms-2 text-light text-muted"> Thana Chowk, Purnia <br> Bihar 854301</span>
                    </div>
                </div>
                <div class="col ">
